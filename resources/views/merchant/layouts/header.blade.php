            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href={{ route('merchant.products') }} aria-expanded="false">
                                <span>
                                    <i class="ti ti-layout-dashboard"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href={{ route('merchant.orders') }} aria-expanded="false">
                                <span>
                                    <i class="ti ti-layout-dashboard"></i>
                                </span>
                        ...
                        <li class="sidebar-item dropdown">
                            ...
                            <ul class="dropdown-menu cwh">
                                {{-- <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('merchant.view.categories') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-user"></i>
                                        </span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('merchant.view.subCategory') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-user"></i>
                                        </span>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                    ...
                                    <div class="message-body">
                                        <a href="{{ route('merchant.myProfile') }}"
